...
# image = Image.open(f'C:\Users\DELL\PycharmProjects\Lab_DL\Lab1\Lab1_2.py/images/{predicted_flower}.jpeg')   # Assuming the images are in jpg format
